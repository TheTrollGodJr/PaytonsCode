...
#It looks like the way you have it is you start at square 1 and depnding of if you choose north, west, east, or south it continue with elif's for that path
#This wouldn't be a huge problem if the paths didn't connect
#I think it would be easier to do by keeping track of the room number as an integer and
    room_number = 1
    ...
    while True:
        ...
        elif "room" + str(room_number) == "room3": #Room 5
                if player_input == "north":
                    #room_number = 8
                    print("You cannot go this way")
                if player_input == "west":
        ...
        elif "room" + str(room_number) == "room3": #Room 6
                if player_input == "north":
                    room_number = 7
        ...
        elif "room" + str(room_number) == "room3": #Room 7
                if player_input == "north":
                    #room_number = 0
                    print("You cannot go this way")
                if player_input == "west":
        ...
        elif "room" + str(room_number) == "room3": #Room 8
                if player_input == "north":
                    #room_number = 8
                    print("You cannot go this way")
                if player_input == "west":
